...
void Level_5::init()
{
	...
	platform[0]->setPosition(glm::vec3(-3.0f, 2.0f, 20.0f));
	platform[1]->setPosition(glm::vec3(-3.0f, 4.0f, 30.0f));
	platform[2]->setPosition(glm::vec3(-3.0f, 2.0f, 40.0f));
	platform[3]->setPosition(glm::vec3(-3.0f, 3.0f, 50.0f));
	platform[4]->setPosition(glm::vec3(-3.0f, 5.0f, 60.0f));
	collectable[0]->setPosition(glm::vec3(-3.0f, 3.0f, 30.0f));
	collectable[1]->setPosition(glm::vec3(-3.0f, 3.0f, 40.0f));
	collectable[2]->setPosition(glm::vec3(-3.0f, 3.0f, 50.0f));
	collectable[3]->setPosition(glm::vec3(-3.0f, 3.0f, 60.0f));
	collectable[4]->setPosition(glm::vec3(-3.0f, 3.0f, 70.0f));
