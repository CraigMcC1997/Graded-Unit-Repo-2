...
void Level_3::init()
{
	...
	platform[2]->setPosition(glm::vec3(-3.0f, 6.0f, 15.0f));
	platform[3]->setPosition(glm::vec3(-3.0f, 8.0f, 20.0f));
	platform[4]->setPosition(glm::vec3(-3.0f, 10.0f, 40.0f));
	collectable[0]->setPosition(glm::vec3(-3.0f, 4.5f, 5.0f));
	collectable[1]->setPosition(glm::vec3(-3.0f, 6.5f, 10.0f));
	collectable[2]->setPosition(glm::vec3(-3.0f, 8.5f, 15.0f));
	collectable[3]->setPosition(glm::vec3(-3.0f, 10.5f, 20.0f));
	collectable[4]->setPosition(glm::vec3(-3.0f, 10.0f, 25.0f));
	enemy[0]->setEnemyPosition(glm::vec3(-3.0f, 0.0f, 10.0f));
	enemy[1]->setEnemyPosition(glm::vec3(-3.0f, 0.5f, 35.0f));
	enemy[0]->setMinRange(glm::vec3(-3.0f, 0.0f, 5.0f));
	enemy[0]->setMaxRange(glm::vec3(-3.0f, 0.0f, 25.0f));
	enemy[1]->setMinRange(glm::vec3(-3.0f, 0.0f, 30.0f));
	enemy[1]->setMaxRange(glm::vec3(-3.0f, 0.0f, 40.0f));
	bush->init();
	tree->init();
}
