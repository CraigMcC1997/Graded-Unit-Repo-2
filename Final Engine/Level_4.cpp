...
void Level_4::init()
{
	...
	platform[1]->setPosition(glm::vec3(-6.0f, 4.0f, 15.0f));
	platform[2]->setPosition(glm::vec3(-6.0f, 2.0f, 30.0f));
	platform[3]->setPosition(glm::vec3(-6.0f, 3.0f, 35.0f));
	platform[4]->setPosition(glm::vec3(-6.0f, 5.0f, 45.0f));
	collectable[0]->setPosition(glm::vec3(-6.0f, 3.0f, 20.0f));
	collectable[1]->setPosition(glm::vec3(-6.0f, 3.0f, 30.0f));
	collectable[2]->setPosition(glm::vec3(-6.0f, 3.0f, 40.0f));
	collectable[3]->setPosition(glm::vec3(-6.0f, 3.0f, 50.0f));
	collectable[4]->setPosition(glm::vec3(-6.0f, 3.0f, 60.0f));
	enemy[0]->setEnemyPosition(glm::vec3(-6.0f, 2.5f, 5.0f));
	enemy[1]->setEnemyPosition(glm::vec3(-6.0f, 0.5f, 30.0f));
	enemy[0]->setMinRange(glm::vec3(0.0f, 0.0f, 4.0f));
	enemy[0]->setMaxRange(glm::vec3(0.0f, 0.0f, 6.0f));
	enemy[1]->setMinRange(glm::vec3(0.0f, 0.0f, 10.0f));
