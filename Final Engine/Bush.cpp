...
void Bush::init()
{
	...
	rt3d::loadObj("../Resources/3D_Objects/CrashBush.obj", verts, norms, tex_coords, indices);
...
void Bush::draw(SDL_Window* window)
{
	...
	for (GLfloat i = -65.0f; i < 295.0f; i++)
	{
