...
void LevelDisplay::init()
{
	...
	textures[1] = loadTexture::loadTextures("../Resources/moss.png");
	textures[2] = loadTexture::loadTextures("../Resources/Jungle1.png");
...
void LevelDisplay::print(SDL_Window* window)
{
	// clear the screen
	...
	mvStack.top() = glm::lookAt(player->eye, player->at, player->up); //pushing camera to top of stack
	...
	collectableDisplay->print(window);	//	drawing collectable
	player->print(window);	//	drawing player
