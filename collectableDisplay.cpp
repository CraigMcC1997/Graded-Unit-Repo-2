...
void CollectableDisplay::print(SDL_Window* window)
{
	...
	mvStack.top() = glm::lookAt(pDisplay->eye, pDisplay->at, pDisplay->up); //pushing camera to top of stack
